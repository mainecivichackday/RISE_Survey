"""
Django settings for our rise project.
...
class Common(Configuration):
    ...
    sys.path.insert(0, os.path.join(BASE_DIR, 'rise/apps'))
    ...
    TEMPLATE_DIRS = (os.path.join(BASE_DIR, "rise/templates"),)
    ...
    STATICFILES_DIRS = (
        os.path.join(BASE_DIR, "rise/static"),
    )
